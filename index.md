...
- My projects, both ones I'm proud about and ones I'm *not* proud about:
  ...
  - [**`beatrun-legacy`**](https://github.com/UnderSet/beatrun-legacy): Pre-fullbody version of datae's Beatrun gamemode with extracted source code
    - Heavily inspired by [JonnyBro/beatrun](https://github.com/JonnyBro/beatrun)
  - [**`re-gm-mw2022hud`**](https://github.com/UnderSet/re-gm-mw2022hud): (Unfinished) *Attempt* to recreate _Call of Duty: Modern Warfare II_ (2022)'s HUD in Garry's Mod
    - [`gm-mw2022hud`](https://github.com/UnderSet/gm-mw2022hud): Previous attempt at the same thing
    - There's actually a third attempt I've written in private, I uh...I just haven't bothered to actually complete it and release it...yeah I'm a fool sometimes.
  - [**`beatrunhud`**](https://gitlab.com/UnderSet/beatrunhud): Garry's Mod custom HUD styled after datae's Beatrun gamemode's own HUD elements.
    - Like literally the first GLua project I've ever done I believe? And also rather obviously aged the worst code quality wise, it's basically held with duct tape at this point.
      - *Fun fact:* I actually still use this as a base for some of my other private projects to this day. I am not rewriting half of that boilerplate.
